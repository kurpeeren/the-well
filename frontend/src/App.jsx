           ...
           {introPhase !== 'WAITING' && (
              <div className="absolute inset-0 overflow-hidden flex items-center justify-center">
                 <video 
                    ...
                    className={`absolute w-full h-full object-contain md:object-cover scale-125 md:scale-100 transition-opacity duration-1000 ${introPhase === 'ENDED' ? 'opacity-20 blur-sm' : 'opacity-100'}`}
                 />
                 <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_center,_transparent_10%,_black_85%)] z-[5]"></div>
                 <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-black via-transparent to-black opacity-100 z-[6]"></div>
                 <div className="absolute inset-0 pointer-events-none bg-gradient-to-r from-black via-transparent to-black opacity-100 z-[7]"></div>
              </div>
           )}
           {introPhase === 'ENDED' && (
              <div 
